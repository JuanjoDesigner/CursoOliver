...
public class SelectorColor extends View {
	...
	public SelectorColor(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private int calcularAncho(int widthMeasureSpec) {
		int res = 200; // Valor por defecto para el ancho
	...
	private int calcularAlto(int heightMeasureSpec) {
		int res = 100; // Valor por defecto para el alto
